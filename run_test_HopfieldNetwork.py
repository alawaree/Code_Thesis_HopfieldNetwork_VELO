...
samples_dataset_minibias = ["Samples_3306_to_4284_neurons"]

for index, sample in enumerate(samples_dataset_minibias):
    save_experiment(
        "results_minibias_samples",
        f"Test of the Hopfield network on the {index+7}th sample minbibias dataset",
        f"Upgraded network - Best Configuration test on 10 events from the {index+7}th sample of minibias dataset ({sample})",
        parameters,
