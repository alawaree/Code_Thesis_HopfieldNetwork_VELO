...
#9,10: "Samples_3265_to_3719_hits", "Samples_3726_to_8666_hits"
    ...
    samples_dataset = ["Samples_2854_to_3405_hits"]

    THRESHOLD_values = [0.04, 0.05, 0.06, 0.07, 0.08, 0.09, 0.1]
...
for index, sample in enumerate(samples_dataset):
    for tr_value in THRESHOLD_values:
            ...
            f"Test of the Hopfield network on the 9th sample minibias dataset with pruning_tr=0.1 and thres={tr_value}",
            f"Upgraded network - Configuration test on 10 events from the 9th sample of minibias dataset ({sample}) with \n halfbif,\n pruning_tr=0.1, \n thres={tr_value}",
            parameters,
