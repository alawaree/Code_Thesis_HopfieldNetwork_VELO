...
for index, sample in enumerate(samples_dataset):
    save_experiment(
        "results_minibias_samples_hits_",
        f"Test of the Hopfield network on the {index+1}th sample minibias dataset",
        f"Upgraded network - Configuration test on 10 events from the {index+1}th sample of minibias dataset ({sample}) with halfbif and pr_tr of 0.01",
        parameters,
