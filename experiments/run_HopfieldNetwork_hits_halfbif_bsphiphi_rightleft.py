...
for index, sample in enumerate(samples_dataset):
    save_experiment(
        "results_bsphiphi_samples_hits_halfbif_rightleft",
        f"Test of the Hopfield network on the {index+1}th sample bsphiphi dataset with half bifurcation fct (RIGHT TO LEFT)",
        f"Upgraded network - Best Configuration test on 10 events from the {index+1}th sample of bsphiphi dataset ({sample}) with half bifurcation fct (RIGHT TO LEFT)",
        parameters,
