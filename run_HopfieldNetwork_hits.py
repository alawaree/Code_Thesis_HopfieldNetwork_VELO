...
for index, sample in enumerate(samples_dataset_minibias):
    save_experiment(
        ...
        f"Test of the Hopfield network on the {index+8}th sample bsphiphi dataset",
        f"Upgraded network - Best Configuration test on 10 events from the {index+8}th sample of bsphiphi dataset ({sample})",
        parameters,
