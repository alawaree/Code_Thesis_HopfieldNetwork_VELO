...
samples_dataset_minibias = ["Samples_2468_to_2853_hits"]

for index, sample in enumerate(samples_dataset_minibias):
    save_experiment(
        "results_minibias_samples_hits",
        f"Test of the Hopfield network on the {index+8}th sample minibias dataset",
        f"Upgraded network - Best Configuration test on 10 events from the {index+8}th sample of minibias dataset ({sample})",
        parameters,
