...
samples_dataset_minibias = ["Samples_2854_to_3405_hits","Samples_3412_to_6786_hits"]

for index, sample in enumerate(samples_dataset_minibias):
    save_experiment(
        "results_minibias_samples_hits",
        f"Test of the Hopfield network on the {index+9}th sample minibias dataset",
        f"Upgraded network - Best Configuration test on 10 events from the {index+9}th sample of minibias dataset ({sample})",
        parameters,
